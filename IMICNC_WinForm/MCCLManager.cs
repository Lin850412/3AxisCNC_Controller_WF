...
namespace IMICNC_WinForm
{
    ...
    static class MCCLManager
    {
        ...
        private async static void ReturnValueCheckAsync(object returnValue, string functionName)
        {
            ...
            {
                Debug.WriteLine("This MCCL" + functionName + "return value has issues");
            }
            else
            {
                Debug.WriteLine("Your result is null,please check code first");
            }
        }
        ...
        public static void StartEMPZ()
        {
            ...
            else
            {
                ...
                // 4.過形成保護
                //MCCL.MCC_EnableLimitSwitchCheck(1);
                //MCCL.MCC_DisableLimitSwitchCheck();
                //MCCL.MCC_SetOverTravelCheck(0);
                //MCCL.MCC_GetOverTravelCheck(0);
        ...
        {
            //0~10?
            MCCL.MCC_EcatSetDacOutputValue(3, 1, num);
        }
        #endregion
